...
export const algorithms = {
  bfs: { name: 'BFS', fn: bfs, type: 'Uninformed' as const, description: 'Explores outward equally in all directions, guaranteeing the shortest path on unweighted grids. \n Time: O(V + E) \n Space: O(V)' },
  dfs: { name: 'DFS', fn: dfs, type: 'Uninformed' as const, description: 'Dives deeply down a single path before backtracking; memory-efficient but rarely finds the shortest path. \n Time: O(V + E) \n Space: O(V)' },
  ucs: { name: 'UCS', fn: ucs, type: 'Uninformed' as const, description: 'Expands the cheapest path first to guarantee the absolute shortest route on weighted grids. \n Time: O(E log V) \n Space: O(V)' },
  greedy: { name: 'Greedy Best-First', fn: greedy, type: 'Informed' as const, description: 'Uses a heuristic guess to aggressively target the goal, making it extremely fast but often sub-optimal. \n Time: O(V log V) \n Space: O(V)' },
  astar: { name: 'A*', fn: aStar, type: 'Informed' as const, description: 'Combines actual accumulated cost with a target heuristic to guarantee a highly efficient, optimal path. \n Time: O(E log V) \n Space: O(V)' },
};
